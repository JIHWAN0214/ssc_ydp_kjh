...
// switch 문
// 하나 이상의 case 문으로 구성
// default가 필수는 아니나 사용하길 권장(if 문의 else 같은 존재)
// default = switch 문의 모든 case가 매칭되지 않을 때 실행됨
...
// let number = Number(prompt("숫자를 입력"));
...
// new Data() 함수
// 내장 함수로써 현재 날짜와 시간을 나타내는 JS Date 객체를 반환
// Q) 내장 함수?
// A) JS 엔진이 기본적으로 제공하는 함수로 개발자의 별도 정의 없이도 사용가능
// 전역 객체에 속해있어 어디서든 접근 가능하고 사용 가능
